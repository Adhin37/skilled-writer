...
<!-- BEGIN GENERATED CONTRACT: sw contract design -->

## The operating contract — the `design` role's slice

Generated from `CLAUDE.md` by `python3 scripts/sw.py contract design --write`. **Do not edit between the markers**; edit `CLAUDE.md` and re-run it, which `sw health` checks.
