...
## The operating contract — the `gate` role's slice

Generated from `CLAUDE.md` by `python3 scripts/sw.py contract gate --write`. **Do not edit between the markers**; edit `CLAUDE.md` and re-run it, which `sw health` checks.
