...
- **A stage advance still earns a voice delta.** Competence that changes nothing about how somebody
  speaks is a number on a sheet, and the reader cannot hear a number.
- **The scene a transition earns is a scene about the change in them**, not about the skill.
...
`conflict-engine` owns the stake ladder — what has to be spent at each cadence, up to the defining
loss every two or three arcs. The ledger here is the record of what that ladder took from *this*
