...
| § | file | open it when |
|---|---|---|
| 5 | `roles/draft/competence-map.acquisition-ladder.md` | somebody is learning something across chapters, or a skill has advanced and you need to know what that cost |
| 6 | `roles/shared/competence-map.broad-knowledge.md` | the character is a god, an immortal, a cultivator with centuries, or an artificial mind — `knowledge_scope: broad` |

The revision-time check is `roles/gate/competence-map.audit-card.md`, opened by `revision-pass` Pass 3.
