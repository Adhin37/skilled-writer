...
| CHAPTER BLOCK | one chapter | 17 lines, hard | once, at drafting; never edited after the arc closes |
...
- [ ] No block exceeds 17 lines — and **every key sits on one physical line**. Soft-wrapping a
